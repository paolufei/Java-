...
public interface StudentRepository extends JpaRepository<Student,Integer> {
    ...
    @Query(value = "from Student where ?1='' or tele like %?1%")
    List<Student> findstudentlistBytele(String tele);

    @Query(value = "select * from Student limit(?1-1)*5,5", nativeQuery = true)
